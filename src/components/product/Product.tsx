                    ...
                    <div className="contentProductZoom">
                        ...
                        <div className="rightCardProductZoom">
                            ...
                            {!editDescribe && !newDescribe ?
                                <p style={{ marginTop: '60px', position: 'relative' }} className="text">{description}<img style={{ marginRight: '15px' }} src={require('../images/edit.png')} className="editLogo" onClick={(e) => { setEditDescribe(true) }} /></p>
                                : !editDescribe && newDescribe ?
