...
export const CGV = () => {
    return(
        <div className="container">
            <Navbar/>
        <div style={{marginTop: '200px'}} className="containerArticleCG">
            <p style={{fontSize: '12px', textAlign: 'justify'}} className="text">
            CONDITIONS GENERALES DE VENTE Modèle-type gratuit - www.donneespersonnelles.fr Entre la Société CLOTHESTAR, immatriculée au Registre du Commerce et des Sociétés de PARIS, sous le numéro SIRET 85372114000012, représentée par M. Thomas Dryjard en qualité de gérant, dûment habilité aux fins des présentes. La société peut être jointe par email en cliquant sur le formulaire de contact accessible via la page d’accueil du site. Ci-après le « Vendeur » ou la « Société ». D’une part, Et la personne physique ou morale procédant à l’achat de produits ou services de la société, Ci-après, « l’Acheteur », ou « le Client » D’autre part, Il a été exposé et convenu ce qui suit : PREAMBULE Le Vendeur est éditeur de Produits et Services de Clothestar à destination de consommateurs, commercialisés par l’intermédiaire de ses sites Internet (http://clothestar.com ). La liste et le descriptif des biens et services proposés par la Société peuvent être consultés sur les sites susmentionnés. 
            </p>
        </div>
            <div className="containerArticleCG">
                <p style={{fontSize: '15px', textAlign: 'start'}} className="title">
                Article 1 : Objet
                </p>
                <p style={{fontSize: '12px', textAlign: 'justify'}} className="text">
                Les présentes Conditions Générales de Vente déterminent les droits et obligations des parties dans le cadre de la vente en ligne de Produits ou Services proposés par le Vendeur. Vous pouvez librement copier-coller ce modèle A CONDITION D'EN INDIQUER LA SOURCE PAR UN LIEN WEB VERS CE DOCUMENT - EXEMPLE : « Nos conditions générales de vente ont été élaborées à partir d'un modèle libre et gratuit qui peut être téléchargé sur le site - https://www.donneespersonnelles.fr/"
                </p>
            </div>
            <div className="containerArticleCG">
                <p style={{fontSize: '15px', textAlign: 'start'}} className="title">
...
Les caractéristiques essentielles des biens, des services et leurs prix respectifs sont mis à disposition de l’acheteur sur les sites Internet de la société, de même, le cas échéant, que le mode d'utilisation du produit. Conformément à l'article L112-1 du Code la consommation, le consommateur est informé, par voie de marquage, d'étiquetage, d'affichage ou par tout autre procédé approprié, des prix et des conditions particulières de la vente et de l'exécution des services avant toute conclusion du contrat de vente. Dans tous les cas, le montant total dû par l'Acheteur est indiqué sur la page de confirmation de la commande. Le prix de vente du produit est celui en vigueur indiqué au jour de la commande, celui-ci ne comportant par les frais de ports facturés en supplément. Ces éventuels frais sont indiqués à l'Achteur lors du process de vente, et en tout état de cause au moment de la confirmation de la commande. Le Vendeur se réserve la possibilité de modifier ses prix à tout moment, tout en garantissant l'application du prix indiqué au moment de la commande. Lorsque les produits ou services ne sont pas exécuté immédiatement, une information claire est donnée sur la page de présentation du produit quant aux dates de livraison des produits ou services. Le client atteste avoir reçu un détail des frais de livraison ainsi que les modalités de paiement, de livraison et d’exécution du contrat, ainsi qu'une information détaillée relative à l'identité du vendeur, ses coordonnées postales, téléphoniques et électroniques, et à ses activités dans le contexte de la présente vente. Le Vendeur s’engage à honorer la commande du Client dans la limite des stocks de Produits disponibles uniquement. A défaut, le Vendeur en informe le Client ; si la commande a été passée, et à défaut d'accord avec le Client sur une nouvelle date de livraison, le Vendeur rembourse le client. Les informations contractuelles sont présentées en détail et en langue française. Les parties conviennent que les illustrations ou photos des produits offerts à la vente n’ont pas de valeur contractuelle. La durée de validité de l’offre des Produits ainsi que leurs prix est précisée sur les sites Internet de la Société, ainsi que la durée minimale des contrats proposés lorsque ceux-ci portent sur une fourniture continue ou périodique de produits ou services. Sauf conditions particulières, les droits concédés au titre des présentes le sont uniquement à la personne physique signataire de la commande (ou la personne titulaire de l’adresse email communiqué).                </p>
            ...
            <div className="containerArticleCG">
                ...
                <p style={{fontSize: '12px', textAlign: 'justify'}} className="text">
                L’exécution des obligations du vendeur au terme des présentes est suspendue en cas de survenance d’un cas fortuit ou de force majeure qui en empêcherait l’exécution. Le vendeur avisera le client de la survenance d’un tel évènement dès que possible.                </p>
            </div>
            <div className="containerArticleCG">
                <p style={{fontSize: '15px', textAlign: 'start'}} className="title">
                ...
                <p style={{fontSize: '12px', textAlign: 'justify'}} className="text">
                Si l’une des stipulations du présent contrat était annulée, cette nullité n’entraînerait pas la nullité des autres stipulations qui demeureront en vigueur entre les parties. Toute modification contractuelle n’est valable qu’après un accord écrit et signé des parties.                 </p>
            </div>
            <div className="containerArticleCG">
                <p style={{fontSize: '15px', textAlign: 'start'}} className="title">
            ...
            <div className="containerArticleCG">
                ...
                <p style={{fontSize: '12px', textAlign: 'justify'}} className="text">
                Toutes les clauses figurant dans les présentes conditions générales de vente, ainsi que toutes les opérations d’achat et de vente qui y sont visées, seront soumises au droit français. La nullité d'une clause contractuelle n'entraîne pas la nullité des présentes conditions générales de vente.                </p>
            </div>
            <div style={{marginBottom: '100px'}} className="containerArticleCG">
                <p style={{fontSize: '15px', textAlign: 'start'}} className="title">
